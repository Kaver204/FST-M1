...
public class GoogleKeep_reminder {
	...
	//WebDriverWait wait;
	WebDriverWait wait;
	String note_title="FST Task-reminder note";
	String note_body="FST Task body in the note reminder";
	@BeforeTest
	public void setUp() throws MalformedURLException {
		...
		public void AddNote()
		{
			try {
				...
				System.out.println("Note body added");
				driver.findElementById("menu_reminder").click();
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("menu_text")));
				driver.findElementById("menu_text").click();
				driver.findElementByXPath("//android.widget.ImageButton[@content-desc='Navigate up']").click();
				System.out.println("Clicked on Back button");
				wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("index_note_title")));
