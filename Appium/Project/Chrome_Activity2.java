...
public class Chrome_Activity2 {
	...
	String password2="password2";
	  ...
	  public void openForm()
	  {
		  ...
		  wait.until(ExpectedConditions.visibilityOfElementLocated(MobileBy.xpath("//android.view.View[contains(@text,'Selenium')]")));
		  driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		  driver.findElement(MobileBy.AndroidUIAutomator("UiScrollable(UiSelector().scrollable(true)).scrollForward(15)"));
		  System.out.println("page scrolled");
		  wait.until(ExpectedConditions.visibilityOfElementLocated(MobileBy.xpath("//android.view.View[contains(@text,'Login Form')]")));
